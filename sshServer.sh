...
#here to create new namespace every time to avoid conflicts
#yeah yeah, not best practice, but easier than to reconfigurate netns every time!
...
sudo ip netns exec $nsName service ssh start
